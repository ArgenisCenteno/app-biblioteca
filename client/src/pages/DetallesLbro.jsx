...
const columnsEjemplar = [
  ...
  { field: 'id_ejemplar', headerName: 'ID Libro', width: 150 },
  { field: 'estado_ejemplar', headerName: 'Estado del Ejemplar', width: 150 },
  { field: 'titulo_libro', headerName: 'Libro', width: 420 },
];

const columnsPrestamo = [
  { field: 'id_ejemplar', headerName: 'ID Préstamo', width: 150 },
...
const DetallesLibro = () => {
  ...
  const getRowId = (row) => data.id_prestamo_proyecto + 1;
    ...
    axios
    .get(`${apiKey}/api/borrow-book/getBorrowByCode/${params.codigo}`)
    .then((response) => {
  ...
  const handleFinishClick = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios
          .put(`${apiKey}/api/borrow-book/finalizar-prestamo/${params.codigo}`)
          .then(() => {
